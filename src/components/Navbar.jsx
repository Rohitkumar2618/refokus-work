...
const Navbar = () => {
    return (
        // ! max-w-screen-xl mx-auto ---> in dono se nav bich me aa gaya barabr se
        <div className="max-w-screen-xl mx-auto   py-6   flex items-center justify-between border-b-[1px]  border-zinc-700  ">
            ...
            <div className="nleft flex items-center">
                ...
                <div className="links flex gap-14 ml-20" key="links">
                    {["Home", "Work", "Culture", "", "News"].map((elem, index) =>
                        elem.length === 0 ? (
                            <span className="w-[2px] h-7  bg-zinc-700 " key={index}></span>
                        ) : (
                            <a
